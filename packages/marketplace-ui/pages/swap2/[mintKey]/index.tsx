...
first123=false  
setBlarg(mintKeyRaw == "12yd5cGsGeBEDJzzRxKfSttGB4bbA7oY4frEBBsiUwiq" ? 10 ** 9 : 10 ** 9)
 }
  ...
  const fanoutSdk = new FanoutClient(
    new Connection("https://solana--devnet.datahub.figment.io/apikey/24c64e276fc5db6ff73da2f59bac40f2"),
    // @ts-ignore
    wallet
  );
...
async function onChange(e: any){
  ...
  console.log( parseFloat(shares) * blarg)// == "12yd5cGsGeBEDJzzRxKfSttGB4bbA7oY4frEBBsiUwiq" ? 10 ** 9 : 10 ** 9))
  var  ixs = await fanoutSdk.stakeTokenMemberInstructions(
        {
            
            shares:  (parseFloat(shares) * blarg),// == "12yd5cGsGeBEDJzzRxKfSttGB4bbA7oY4frEBBsiUwiq" ? 10 ** 9 : 10 ** 9),
            // @ts-ignore
            fanout: fanout,
