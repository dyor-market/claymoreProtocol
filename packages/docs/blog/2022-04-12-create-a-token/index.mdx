...
Head over to the [Claymore Protocol](https://app.strataprotocol.com). Select “Create a Token”
...
This is the easiest part. Head over to the [Claymore Protocol](https://app.strataprotocol.com) and select Create a Token
